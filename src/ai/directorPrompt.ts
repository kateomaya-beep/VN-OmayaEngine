...
- Во ВСЕХ полях characterId и statId используй ТОЧНЫЕ id из контекста (char_…, id статов
  из списка Stats) — НИКОГДА не отображаемые имена. «Дэмиан» — это имя, char_damian — id.
