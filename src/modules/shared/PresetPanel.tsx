        ...
        <div className="grid sm:grid-cols-2 gap-3">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="text-xs text-amber-300/80 mt-1">
              У части моделей размышление не выключается совсем: <b>Gemini 3</b> (ступени низкая /
              средняя / высокая, по умолчанию средняя), GLM-5.x, Kimi, DeepSeek-R1 (низкая /
              высокая / максимальная). «Выкл» для них невыразимо, и движок сам приводит его к самой
              низкой ДОПУСТИМОЙ ступени — как по имени модели, так и по отказу шлюза.
            </p>
            <p className="text-xs text-amber-300/80 mt-1">
              А вот «Авто» на такой модели означает НЕ «побыстрее», а её собственный дефолт: Gemini 3
              думает над каждым ходом на среднем уровне, GLM — на максимальном. Ответ идёт заметно
              дольше, и на экране при этом пусто: свои мысли эти шлюзы наружу не отдают. Если Gemini
              вдруг стала «вечной» — проверьте, что здесь не «Авто», и нажмите «Забыть выученное про
          ...
          <Field label={`Бюджет контекста: ${cfg.contextBudget} ток. (жёсткий потолок запроса)`}>
            ...
            <p className="text-[11px] text-gray-500 mt-1">
              ...
              помещаться в свободное место бюджета, память сворачивается в главу меморибука — раньше,
