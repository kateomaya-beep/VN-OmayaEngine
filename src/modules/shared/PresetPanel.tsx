      ...
      <div className="card !bg-panel2 mt-4">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          ...
          <Field label={`Бюджет контекста: ${cfg.contextBudget} ток. (жёсткий потолок запроса)`}>
            ...
            <p className="text-[11px] text-gray-500 mt-1">
              Дефолт 80 000 — это запрос примерно на 45–70 тыс. токенов, то есть нужна модель со
              128k контекста (Gemini, Claude, GPT-4o и новее). Если провайдер отвечает «не
              помещается в контекст» — снизьте бюджет. Больше — дороже и медленнее каждый ход,
              а выше ~120 000 прибавка почти незаметна.
            </p>
          </Field>
        </div>
      </div>
